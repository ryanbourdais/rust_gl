...
fn main() {
    ...
    event_loop.run(move |event, _, control_flow| {
        ...
        *control_flow = glutin::event_loop::ControlFlow::WaitUntil(next_frame_time);
        ...
        target.draw((&positions, &normals), &indices, &program, &uniform! { model: matrix, view: view, perspective: perspective, u_light: light }, &params).unwrap();
